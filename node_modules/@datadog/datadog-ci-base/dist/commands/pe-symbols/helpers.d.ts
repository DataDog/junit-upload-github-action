...
export declare const getPERequestBuilder: (apiKey: string, cliVersion: string, site: string) => (args: import("axios").AxiosRequestConfig<any>) => Promise<import("axios").AxiosResponse<any, any, {}>>;
